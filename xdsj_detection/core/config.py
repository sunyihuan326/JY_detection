...
# Set the class name
__C.YOLO.CLASSES                 = "E:/JY_detection/xdsj_detection/data/classes/JoyRobot_22.names"
...
__C.TRAIN.ANNOT_PATH           = "./data/dataset/train22_1111.txt"
...
__C.TRAIN.FISRT_STAGE_EPOCHS   = 90
__C.TRAIN.SECOND_STAGE_EPOCHS  = 0
# __C.TRAIN.INITIAL_WEIGHT             ="./checkpoint/padding_resize/mAP94/yolov3_test_loss=1.5903.ckpt-40"
__C.TRAIN.INITIAL_WEIGHT       = "./checkpoint/yolov3_test_loss=2.6475.ckpt-80"

# TEST options
__C.TEST = edict()

__C.TEST.ANNOT_PATH             = "./data/dataset/test22_1111.txt"
