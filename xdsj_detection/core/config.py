...
__C.YOLO.CLASSES                     = "E:/JY_detection/xdsj_detection/data/classes/JoyRobot_14.names"
...
__C.TRAIN.ANNOT_PATH                 = "./data/dataset/JoyRobot_train14.txt"
...
__C.TRAIN.INITIAL_WEIGHT             = "./checkpoint/yolov3_train_loss=4.3752.ckpt-50"

# TEST options
__C.TEST = edict()

__C.TEST.ANNOT_PATH                  ="./data/dataset/JoyRobot_test14.txt"
