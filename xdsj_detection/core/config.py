...
# Set the class name
__C.YOLO.CLASSES                 = "E:/JY_detection/xdsj_detection/data/classes/JoyRobot_9.names"
...
__C.TRAIN.ANNOT_PATH           = "./data/dataset/train9_1229.txt"
...
__C.TRAIN.INITIAL_WEIGHT       = "./checkpoint/yolov3_test_loss=1.5417.ckpt-55"

# TEST options
__C.TEST = edict()

__C.TEST.ANNOT_PATH             = "./data/dataset/test9_1222.txt"
