...
gt_txt_root = "E:/kx_detection/detection/mAP/ground-truth"
pre_txt_root = "E:/kx_detection/detection/mAP/predicted"
...
def get_accuracy(error_write=True):
    ...
    error_dir2 = "E:/kx_detection/detection/mAP/error2/"
    if os.path.exists(error_dir2): shutil.rmtree(error_dir2)
    os.mkdir(error_dir2)

    error_dir3 = "E:/kx_detection/detection/mAP/error3/"
