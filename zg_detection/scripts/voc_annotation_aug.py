...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_annotation",
                        default="E:/kx_detection/detection/data/dataset/202003_aug/train_all0318_resize.txt")
    parser.add_argument("--test_annotation",
                        default="E:/kx_detection/detection/data/dataset/202003_aug/test_all0318_resize.txt")
    # parser.add_argument("--val_annotation",
    #                     default="E:/kx_detection/detection/data/dataset/202003/val0318.txt")
