...
class YoloPredic(object):
    ...
    def __init__(self):
        ...
        self.top_n = 5
        self.saved_model_file = "./savemodel/yolov3/3"  # saved_model文件地址
        ...
        with graph.as_default():
            ...
            sm.loader.load(self.sess, ["serve"], self.saved_model_file)
